// Code generated from /workspace/jkdeps/grammars/java/java20/Java20Parser.g4 by ANTLR 4.13.2. DO NOT EDIT.

package java20parser // Java20Parser
...
func (s *BaseJava20ParserListener) EnterGuard(ctx *GuardContext) {}

// ExitGuard is called when production guard is exited.
func (s *BaseJava20ParserListener) ExitGuard(ctx *GuardContext) {}
...
// EnterRecordPattern is called when production recordPattern is entered.
func (s *BaseJava20ParserListener) EnterRecordPattern(ctx *RecordPatternContext) {}

// ExitRecordPattern is called when production recordPattern is exited.
func (s *BaseJava20ParserListener) ExitRecordPattern(ctx *RecordPatternContext) {}

// EnterComponentPatternList is called when production componentPatternList is entered.
func (s *BaseJava20ParserListener) EnterComponentPatternList(ctx *ComponentPatternListContext) {}

// ExitComponentPatternList is called when production componentPatternList is exited.
func (s *BaseJava20ParserListener) ExitComponentPatternList(ctx *ComponentPatternListContext) {}

// EnterComponentPattern is called when production componentPattern is entered.
func (s *BaseJava20ParserListener) EnterComponentPattern(ctx *ComponentPatternContext) {}

// ExitComponentPattern is called when production componentPattern is exited.
func (s *BaseJava20ParserListener) ExitComponentPattern(ctx *ComponentPatternContext) {}
